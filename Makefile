...
C_SOURCES = $(wildcard kernel/arch/*.c kernel/klibc/*.c kernel/drivers/*.c kernel/klibc/stdio/*.c kernel/mem/*.c kernel/syscall/*.c kernel/filesystem/*.c)
#Headers files list
HEADERS = $(wildcard kernel/arch/include/*.h kernel/klibc/include/*.h kernel/drivers/include/*.h kernel/mem/include/*.h kernel/syscall/include/*.h kernel/filesystem/include/*.h)
#compiled files .o
